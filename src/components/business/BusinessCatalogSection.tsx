      ...
      {filtered.length > 0 ? (
        <div className={businessPageCatalogGrid}>
          {filtered.map((item, index) => (
            <article
              key={item.id}
              className="flex flex-col overflow-hidden rounded-2xl bg-white shadow-[0_1px_2px_rgba(16,22,32,0.05)] transition-transform transition-shadow duration-200 hover:scale-[1.01] hover:shadow-md"
            >
              <div
